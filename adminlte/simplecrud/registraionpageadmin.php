...
<body>
  ...
  <?php if (!empty($_SESSION['old']['profile_image'])): ?>
    <img src="uploads/<?= $_SESSION['old']['profile_image']; ?>"
...
<textarea id="address" name="address" class="form-control" rows="4"><?= $_SESSION['old']['address'] ?? '' ?></textarea>
